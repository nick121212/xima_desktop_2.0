...
namespace XIMALAYA.PCDesktop.Core.Data
{
    ...
    public partial class CategoryDataConfigDecorator<T, T1> : JsonConfigDecorator<T, T1>
        ...
        where T1 : class
    {
        ...
        /// 配置类
        /// </summary>
        public CategoryDataConfigDecorator(IJsonConfig decorator, JsonConfiguration<T1> config) : base(decorator, config) { }
