...
namespace XIMALAYA.PCDesktop.Core.Data
{
    ...
    public partial class SoundDataConfigDecorator<T, T1> : JsonConfigDecorator<T, T1>
        where T : SoundData
        where T1 : class
    {
        ...
        /// 配置类
        /// </summary>
        public SoundDataConfigDecorator(IJsonConfig decorator, JsonConfiguration<T1> config) : base(decorator, config) { }
