...
{
 public partial class SuperExploreIndexResultConfig<T> : IJsonConfig
        where T : SuperExploreIndexResult
    {
        ...
        /// 配置类
        /// </summary>
        public JsonConfiguration<SuperExploreIndexResult> Config { get; set; }
        /// <summary>
        /// 构造函数
        /// </summary>
        public SuperExploreIndexResultConfig()
        {
            this.Config = Json.ConfigurationFor< SuperExploreIndexResult>();
            this.AddConfig();
        }
        /// <summary>
        /// 添加配置
