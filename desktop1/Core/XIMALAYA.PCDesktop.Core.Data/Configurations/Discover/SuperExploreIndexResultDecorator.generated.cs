    ...
    public partial class SuperExploreIndexResultDecorator<T> : Decorator<T>
    {
        ...
        public override void doAddConfig()
        {
            ...
            this.Config.MapType<SuperExploreIndexResult>(map => map
                    ...
                    .Field<XIMALAYA.PCDesktop.Core.Models.Subject.SubjectData>(field => field.LatestActivity, type => type.To("latest_activity"))
                    .Field<XIMALAYA.PCDesktop.Core.Models.Subject.SubjectData>(field => field.LatestSpecial, type => type.To("latest_special"))
