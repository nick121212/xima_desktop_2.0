...
namespace XIMALAYA.PCDesktop.Tools.T4
{
    /// <summary>
    /// T4实体模型信息类
    /// </summary>
    public class T4ModelInfo
    {
        ...
        public T4ModelInfo(Type modelType, bool useModuleDir = false)
        {
            ...
            //var a = Properties.Where(p=>p.GetCustomAttributes<DataContractAttribute>(true).Count()>0);

            //modelType.Assembly.GetTypes().Where(t=>t.GetCustomAttributes<DataContractAttribute>(true).Count()>0)
